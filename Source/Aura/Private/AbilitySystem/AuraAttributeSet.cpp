...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	/** Vital Attributes */
	TagsToAttributesMap.Add(GameplayTags.Attributes_Vital_Health, GetHealthAttribute());
	TagsToAttributesMap.Add(GameplayTags.Attributes_Vital_Mana, GetManaAttribute());
...
/**
 * This function will not apply the new value, to apply the value it should be done on the PostGameplayEffectExecute
 * @param Attribute 
 * @param NewValue 
 */
...
void UAuraAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	// Check if the character is dead before executing the effect
...
void UAuraAttributeSet::HandleDebuff(const FEffectProperties& Props)
{
	...
	if (MutableSpec)
	{
		...
		{
			const TSharedPtr<FGameplayTag> DebuffDamageType = MakeShareable<FGameplayTag>(new FGameplayTag(DamageType));
